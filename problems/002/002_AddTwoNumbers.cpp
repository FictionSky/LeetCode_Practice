...
int main() {
    Solution solution;
    cout << "练习目标：2. Add Two Numbers" << '\n';
    cout << "只需要补全 addTwoNumbers() 的 TODO 区域，再重新运行本地样例。" << "\n\n";
    {
        ListNode* list1 = buildList({2, 4, 3});
        ListNode* list2 = buildList({5, 6, 4});
