...
int main() {
    Solution solution;
    cout << "练习目标：106. Construct Binary Tree from Inorder and Postorder Traversal" << '\n';
    cout << "只需要补全 buildTree() 的 TODO 区域，再重新运行本地样例。" << "\n\n";
    {
        ...
        cout << '\n';
        cout << "预期结果：";
        printValue(vector<string>{"3", "9", "20", "null", "null", "15", "7"});
        cout << "\n\n";
    }
    return 0;
}
