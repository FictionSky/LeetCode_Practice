...
int main() {
    Solution solution;
    cout << "练习目标：160. Intersection of Two Linked Lists" << '\n';
    cout << "只需要补全 getIntersectionNode() 的 TODO 区域，再重新运行本地样例。" << "\n\n";
    {
        ListNode* sharedTail = buildList({8, 4, 5});
        ListNode* headA = appendSharedTail({4, 1}, sharedTail);
        ListNode* headB = appendSharedTail({5, 6, 1}, sharedTail);
