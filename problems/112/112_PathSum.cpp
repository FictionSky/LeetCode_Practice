...
int main() {
    Solution solution;
    cout << "练习目标：112. Path Sum" << '\n';
    cout << "只需要补全 hasPathSum() 的 TODO 区域，再重新运行本地样例。" << "\n\n";
    {
        TreeNode* root = buildTree({"5", "4", "8", "11", "null", "13", "4", "7", "2", "null", "null", "null", "1"});
        auto actual = solution.hasPathSum(root, 22);
        cout << "示例 1" << '\n';
        cout << "当前结果：";
        printValue(actual);
        cout << '\n';
