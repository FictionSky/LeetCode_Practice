...
int main() {
    Solution solution;
    cout << "练习目标：1372. Longest ZigZag Path in a Binary Tree" << '\n';
    cout << "只需要补全 longestZigZag() 的 TODO 区域，再重新运行本地样例。" << "\n\n";
    {
        TreeNode* root = buildTree({"1", "null", "1", "1", "1", "null", "null", "1", "1", "null", "1"});
        auto actual = solution.longestZigZag(root);
        cout << "示例 1" << '\n';
        cout << "当前结果：";
        printValue(actual);
        cout << '\n';
